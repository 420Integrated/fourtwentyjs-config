...
# that this very package will be located at ./node_modules/@fourtwentyjs/eslint-config-defaults, relatively from the host package.

# 1) The traditional way: 
#   + fourtwentyjs-vm
#     - packages/vm/node_modules/@fourtwentyjs/eslint-config-defaults
# 
# 2) The hoisted way
#   + fourtwentyjs-vm
#     - node_modules/fourtwentyjs/eslint-config-defaults [1]
#     - packages/vm/node_modules/@fourtwentyjs/eslint-config-defaults (symlink to [1])
# 
# 3) The local development way (using npm link)
#   + fourtwentyjs-config/packages/lint [1]
#   + fourtwentyjs-vm
#     - packages/vm/node_modules/@fourtwentyjs/eslint-config-defaults (symlink to [1])
# 
